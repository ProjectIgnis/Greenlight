...
function s.initial_effect(c)
	...
	c:RegisterEffect(e2)
	--Provide an effect to a "Six Samurai" monster Synchro Summoned using this card as material
...
function s.effcon(e,tp,eg,ep,ev,re,r,rp)
	return (r&REASON_SYNCHRO)==REASON_SYNCHRO and e:GetHandler():GetReasonCard():IsSetCard(SET_SIX_SAMURAI)
end
