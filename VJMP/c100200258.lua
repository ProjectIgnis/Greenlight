...
function s.initial_effect(c)
	--Special Summon 2 Level 3 Insect monsters with the same name
...
function s.spop(e,tp,eg,ep,ev,re,r,rp)
	...
	--Banish them in the End Phase
	aux.DelayedOperation(sg,PHASE_END,id,e,tp,function(ag) Duel.Remove(ag,nil,REASON_EFFECT) end,nil,0,1,aux.Stringid(id,1))
