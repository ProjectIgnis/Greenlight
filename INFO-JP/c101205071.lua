...
function s.spfilter(c,e,tp)
	return c:IsSetCard(SET_WHITE_WOODS) and c:IsCanBeSpecialSummoned(e,0,tp,false,false)
end
...
function s.scfilter(c)
	return c:IsSetCard(SET_WHITE_WOODS) and c:IsSynchroSummonable(nil)
end
