...
function s.initial_effect(c)
	--Add to the hand 1 "Raidraptor" monster a different level from the targe
	...
	c:RegisterEffect(e1)
	--Increase or decrease the Level of all "Raidraptor" monsters you control
...
function s.thfilter(c,lv)
	return c:IsSetCard(SET_RAIDRAPTOR) and not c:IsLevel(lv) and c:IsAbleToHand()
end
