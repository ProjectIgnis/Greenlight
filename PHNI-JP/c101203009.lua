...
function s.initial_effect(c)
	-- Special Summon 1 "Goblin Rider" monster from your GY
	...
	e3:SetTarget(s.spgytg)
	e3:SetOperation(s.spgyop)
	c:RegisterEffect(e3)
end
s.listed_series={SET_GOBLIN_RIDER}
function s.spfilter(c,e,tp)
	return c:IsSetCard(SET_GOBLIN_RIDER) and c:IsCanBeSpecialSummoned(e,0,tp,false,false) and not c:IsCode(id)
end
