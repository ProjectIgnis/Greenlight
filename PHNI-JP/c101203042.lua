...
function s.pltg(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
	if chkc then return Duel.GetLocationCount(chkc:GetOwner(),LOCATION_SZONE)>0 and chkc:IsMonster() and chkc:IsFaceup() and not chkc:IsForbidden()
		and ((chkc:IsControler(tp) and chkc:IsLocation(LOCATION_GRAVE)) or (chkc:IsControler(1-tp) and chkc:IsLocation(LOCATION_MZONE))) end
