...
function s.initial_effect(c)
	...
	c:RegisterEffect(e1)
	--"Allure Queen" monsters you control gain ATK equal to the ATK of the monsters equipped to them by their effects
	...
	c:RegisterEffect(e2)
	--Special Summon as many "Allure Queen" monster with different names as possible
...
s.listed_names={100305028} --Allure Pallace
...
function s.atkvalue(e,c)
	local eqg=c:GetEquipGroup():Filter(s.eqpfilter,nil,c:GetCode())
	return #eqc>0 and eqg:GetSum(Card.GetTextAttack) or 0
end
