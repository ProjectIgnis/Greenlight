...
function s.rmop(e,tp,eg,ep,ev,re,r,rp)
	...
	if aux.RemoveUntil(rg,nil,REASON_EFFECT,PHASE_END,id,e,tp,aux.DefaultFieldReturnOp)
		...
		local tg=thg:Select(tp,1,#Duel.GetOperatedGroup(),nil)
...
function s.sptg(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.IsExistingMatchingCard(s.spfilter,tp,LOCATION_DECK|LOCATION_EXTRA,0,1,nil,e,tp,rp) end
