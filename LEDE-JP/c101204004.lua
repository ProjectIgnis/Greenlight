...
function s.thfilter(c)
	return (c:IsCode(CARD_LIGHT_SARC) or c:IsSpellTrap() and c:ListsCode(CARD_LIGHT_SARC)) and c:IsAbleToHand()
end
...
function s.setfilter(c)
	return c:IsCode(101204071) and c:IsSSetable() and not c:IsForbidden()
end
